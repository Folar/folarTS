...
var ViridisRegister= React.createClass({
    ...
    submitText2: function() {
                ...
                this.state.regSource.fetch({ data: { fn: firstName.value, ln: lastName.value, email:email.value, password:password.value,
                                                          ...
                                                          dept: dept.value, trial:trial.value},
    ...
    success : function(){
         var func  = this.props.func;
          ...
          var temp = this.state.regSource.map(function(data, key) {
    ...
    return (
     ...
     componentDidMount: function() {
          ...
          trial = $(this.refs.trial.getDOMNode())[0];
